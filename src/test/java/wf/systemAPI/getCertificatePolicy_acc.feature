Feature: Fetching  policy details through GET call in policy-group-rs for ACCIDENT_1 coverage
  ...
  Scenario Outline: Validate get certificate policy details for given Claim ID : <Policy_number>
    ...
    * match response.premiums[0].tier == '<exp_tier>'
    ...
    Examples:
      ...
      | CP0001002025  | 520787             | issued             | MP0001002000          |  510005                       | ACCIDENT_1     | Accident 1       |   EEO    |
      | CP0001003505  | 520791             | issued             | MP0001002000          |  510005                       | ACCIDENT_1     | Accident 1       |   EEC    |
